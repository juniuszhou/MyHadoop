...
public class Calculator implements org.apache.thrift.TBase<Calculator, Calculator._Fields>, java.io.Serializable, Cloneable, Comparable<Calculator> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Calculator");
  ...
  static {
    schemes.put(StandardScheme.class, new CalculatorStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CalculatorTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Calculator.class, metaDataMap);
  }
  ...
  public Calculator setWhatOp(int whatOp) {
    this.whatOp = whatOp;
    setWhatOpIsSet(true);
    return this;
  }
  ...
  public Calculator setWhy(String why) {
    this.why = why;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof Calculator)
      return this.equals((Calculator)that);
    return false;
  }

  public boolean equals(Calculator that) {
    if (that == null)
      return false;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("Calculator(");
    boolean first = true;
  ...
  private static class CalculatorStandardSchemeFactory implements SchemeFactory {
    public CalculatorStandardScheme getScheme() {
      return new CalculatorStandardScheme();
    }
  }

  private static class CalculatorStandardScheme extends StandardScheme<Calculator> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Calculator struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Calculator struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CalculatorTupleSchemeFactory implements SchemeFactory {
    public CalculatorTupleScheme getScheme() {
      return new CalculatorTupleScheme();
    }
  }

  private static class CalculatorTupleScheme extends TupleScheme<Calculator> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Calculator struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Calculator struct) throws org.apache.thrift.TException {
